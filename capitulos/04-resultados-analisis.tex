...
La caracterización climática se construye a partir del archivo diario de San Cristóbal incorporado en la carpeta de datos de la tesis. El registro corresponde al año climático de referencia 2002 y contiene temperatura exterior, punto de rocío, radiación solar directa y difusa, velocidad y dirección del viento, presión atmosférica, altura solar y acimut solar.

Los datos describen una condición cálido-húmeda, con temperatura media anual de $24,28\,^{\circ}\mathrm{C}$, humedad relativa media estimada de $81,06\,\%$ y radiación global diaria media estimada de $7,29\,\mathrm{kWh}/\mathrm{m}^{2}$. La temperatura media mensual más alta se registra en marzo, con $27,10\,^{\circ}\mathrm{C}$, mientras que septiembre presenta la media mensual más baja, con $21,73\,^{\circ}\mathrm{C}$. La velocidad media anual del viento es de $4,90\,\mathrm{m/s}$, con dirección media cercana a $156^{\circ}$, lo que sugiere la necesidad de analizar la ventilación natural según orientación, permeabilidad de fachada y recorrido interior del aire.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{4.2cm}p{3cm}p{5.2cm}}
    ...
    Humedad relativa estimada & $81,06\,\%$ & Controlar ventilación, condensación y selección de materiales. \\
    Radiación global diaria media & $7,29\,\mathrm{kWh}/\mathrm{m}^{2}$ & Diseñar protecciones solares y reducir ganancias por cubierta y fachada. \\
    Velocidad media del viento & $4,90\,\mathrm{m/s}$ & Evaluar ventilación cruzada y extracción natural. \\
    Dirección media del viento & $156^{\circ}$ & Relacionar orientación de aberturas con vientos predominantes. \\
    \bottomrule
  \end{tabular}
