\par\medskip
\subsection{Comparación conjunta de los ensayos revisión 01}
...
\end{table}
C3 presenta una variación de -2,37\,\% frente al CB. La diferencia entre C3 y C1 es de -354,80 kWh térmicos al año. La interacción entre paquetes, definida como el ahorro combinado menos la suma de los ahorros independientes, es -75,76 kWh térmicos al año; la respuesta es subaditiva. Con $A_i=Q_{CB}-Q_i$, la interacción es $A_{C3}-(A_{C1}+A_{C2})=-75,76$ kWh. Si se expresa mediante variaciones de demanda $\Delta Q_i=Q_i-Q_{CB}$, el término equivalente cambia de signo y vale $+75,76$ kWh; no cambia la interpretación física.
...
La revisión del capítulo 3 distingue la ejecución energética de la verificación integral de sostenibilidad. En la revisión 01, el esquema de cuatro archivos independientes se mantiene, pero el alcance material todavía es parcial: C2 y C3 ensayan reflectancia y no acreditan contenido reciclado, bajo carbono ni menor huella ambiental. Esta diferencia respecto al alcance previsto se conserva expresamente y no se sustituye por una conclusión ambiental basada solo en energía.
