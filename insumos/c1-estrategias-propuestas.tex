...
Para aislar el efecto de C1, se conservaron la orientación, la materialidad, el clima, la ocupación, las cargas y las consignas del caso base. C2 revisión 01 estudia el acabado reflectante; los cambios adicionales de capas y vidrio se incorporan en C3 revisión 02. La cubierta del atrio y las rejillas superiores forman parte de la configuración base y se mantienen.
...
\fuente{Elaboración propia. Esquema conceptual. El archivo exportado confirma modo mixto en seis oficinas y límites de temperatura exterior de 20--26 \textdegree C, adoptados como supuestos de diseño.}
\end{figure}
...
\addlinespace
Operación & Controles particulares del modelo base. & Modo mixto en seis oficinas, exterior 20--26 \textdegree C. & Respuesta horaria, confort y operación efectiva. \\
\addlinespace
