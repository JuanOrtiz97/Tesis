...
\begin{tikzpicture}[
  ...
  \node[anchor=north west,problemaEtiqueta] at (0.1,10.85) {ALCANCE Y DELIMITACIÓN};
  ...
  \node[anchor=north west,font=\fontfamily{phv}\selectfont\fontsize{17}{20}\selectfont] at (0.1,10.05)
    {Del proyecto de diseño\\\textbf{al alcance de la evidencia}};
  ...
  \node[anchor=north west,problemaTitulo] at (0.62,8.35) {Unidad de análisis};
  \node[anchor=north west,problemaTexto] at (0.62,7.73)
    {Edificio de la Defensoría\\del Pueblo en San Cristóbal.};

  \node[anchor=north west,problemaNumero] at (0.10,5.65) {02};
  \node[anchor=north west,problemaTitulo] at (0.62,5.65) {Trabajo incluido};
  \node[anchor=north west,problemaTexto] at (0.62,5.03)
    {Matriz, modelo energético\\y comparación de\\escenarios de diseño.};

  \node[anchor=north west,problemaNumero] at (0.10,2.58) {03};
  \node[anchor=north west,problemaTitulo] at (0.62,2.58) {Condiciones declaradas};
  \node[anchor=north west,problemaTexto] at (0.62,1.96)
    {Clima, cargas, horarios\\y propiedades del modelo.};

  % Problema central, situado sobre la superficie semicircular.
  \node[anchor=north west,problemaEtiqueta,text=introBlue] at (5.57,6.22) {TIPO DE ESTUDIO};
  \node[anchor=north west,font=\fontfamily{phv}\selectfont\bfseries\fontsize{11.5}{14}\selectfont] at (5.57,5.72)
    {Evaluación\\prospectiva y\\comparativa};
  ...
  \node[anchor=north west,problemaEtiqueta,text=introBlue] at (9.20,8.16) {FUERA DEL ALCANCE EJECUTADO};
  \node[anchor=north west,font=\fontfamily{phv}\selectfont\bfseries\fontsize{16}{19}\selectfont] at (9.20,7.60)
    {Delimitar las\\conclusiones};
  \node[anchor=north west,problemaTexto] at (9.20,6.12)
    {Los resultados no sustituyen\\la verificación del edificio.};
  ...
  \node[anchor=west,problemaTitulo] at (10.31,4.87) {Operación medida};
  \node[anchor=west,problemaTexto] at (10.31,4.43) {Sin calibración ni monitoreo};
  \node[anchor=west,problemaTitulo] at (10.31,3.35) {Proyecto ejecutivo};
  \node[anchor=west,problemaTexto] at (10.31,2.91) {Sin diseño HVAC detallado};
  \node[anchor=west,problemaTitulo] at (10.31,1.83) {Cierre económico};
  \node[anchor=west,problemaTexto] at (10.31,1.39) {Sin presupuesto definitivo};
  ...
  \node[anchor=south east,problemaEtiqueta] at (14.85,0.15)
    {Caso \quad / \quad Evaluación \quad / \quad Límites};
\end{tikzpicture}
\endgroup
