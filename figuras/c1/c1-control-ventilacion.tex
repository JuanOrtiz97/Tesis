...
\node[anchor=west,font=\rmfamily\bfseries\large] at (.2,7.1) {04 / Ventilación coordinada con refrigeración};
\node[anchor=west,text=orange] at (.2,6.5) {CRITERIO C1 · Control térmico aplicado en seis oficinas};
...
\node[anchor=west,text width=14cm,align=left] at (.2,.65) {Definir y comprobar: horarios, umbrales de temperatura, restricciones de viento y lluvia y coordinación con HVAC. Control por temperatura y modo mixto activos; intervalo exterior de 20 a 26 grados Celsius.};
