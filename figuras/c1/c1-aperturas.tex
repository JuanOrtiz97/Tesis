...
\node[anchor=west,font=\sffamily\bfseries\large] at (.2,7.1) {02 / Área libre de ventanas};
\node[anchor=west,text=orange] at (.2,6.5) {PROPUESTA C1 · Elevaciones conceptuales, sin escala};
...
\node[align=center] at (11,3.7) {\textbf{20\,\% a ensayar}\\Oficinas seleccionadas};
...
\node[anchor=west,text width=14cm,align=left,font=\sffamily\footnotesize] at (.2,.5) {Las franjas representan proporciones de área; no son detalles de carpintería. El 20\,\% es una hipótesis de diseño y no implica un caudal cuatro veces mayor.};
